...
# 
#
#. debug : ['on','off']-['True','False']-'Debug mode'
#
...
#
#. colorMode : ['none','weight','grade','full']-['None','weight','grade','full']-'Color profile'
#
#. customColors : ['on','off']-['True','False']-'Custom color file'
#
#. ttdefault : ['lesson','day']-['l','d']-'Default behaviour for number inputs in timetable menu'
#
#. prettyUser : ['yes','no']-[True,False]-'"yes" shows the persons name, no shows their data in the profiles menu'
#
#. animTime : input-'Time between animation frames (0.001*x)'
#
